...
def launch_setup(context, *args, **kwargs):
    ...
    parent_frame = LaunchConfiguration(
        "parent_frame", default="end_effector_link"
    ).perform(context)
...
def generate_launch_description():
    ...
    this_package_prefix = get_package_share_directory("arm_control_marmotte")

    declared_arguments = [
        DeclareLaunchArgument("name", default_value="oak"),
        DeclareLaunchArgument("namespace", default_value=""),
        DeclareLaunchArgument("parent_frame", default_value="end_effector_link"),
        DeclareLaunchArgument("camera_model", default_value="OAK-D-PRO"),
        DeclareLaunchArgument("cam_pos_x", default_value="0.0"),
        DeclareLaunchArgument("cam_pos_y", default_value="0.092"),
        DeclareLaunchArgument("cam_pos_z", default_value="0.0"),
        DeclareLaunchArgument("cam_roll", default_value="0.0"),
        DeclareLaunchArgument("cam_pitch", default_value="-1.57"),
        DeclareLaunchArgument("cam_yaw", default_value="1.57"),

        DeclareLaunchArgument(
            "params_file",
            default_value=os.path.join(this_package_prefix, "config", "camera.yaml"),
        ),
